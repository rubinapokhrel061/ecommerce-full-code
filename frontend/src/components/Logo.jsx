  ...
  return (
    <div>
      ...
      >
        ...
        {(!logoImage || isShow) && (
          <span className="capitalize text-xl md:text-2xl font-bold tracking-tight font-sans bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent">
            {websiteName}
          </span>
        )}
      </Link>
